function TrialNumber = HL_ReadBitCode(bitcode_ch,sr)
% TrialNumber = HL_ReadBitCode(xsg)
%
%  INPUT:
...
xsg_sample_rate = sr;
BinaryThreshold = bitcode_ch>ThresholdValue; 
...
bitcode_time_samples = 125*(xsg_sample_rate/1000); % ?? 125 ms
